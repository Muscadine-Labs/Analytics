...
export async function GET(
  ...
  try {
    ...
    const revenue = { revenueAllTime: null as number | null, feesYtd: null as number | null };

    let data: VaultDetailQueryResponse;
    try {
      data = await morphoGraphQLClient.request<VaultDetailQueryResponse>(query, variables);
